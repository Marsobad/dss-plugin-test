# Code for custom code recipe plugin (imported from a Python recipe)
...
fake_hubspot_export_copy_df = fake_hubspot_export_df # For this sample code, simply copy input to output
